...
link.rel = 'icon';
link.href = 'ressources/images/e250800f575b.png';
...
if (typeof moveTitleLp === "function") {
    moveTitleLp();
}
$(window).on("load", function() {
...
$(".scrollUp").click(function(){$("html,body").animate({scrollTop:0},"slow")});var lastScrollTop=0;$(window).scroll(function(l){var o=$(this).scrollTop(),s=$(window).scrollTop();o>lastScrollTop?$(".scrollUp").removeClass("active"):s>100?$(".scrollUp").addClass("active"):$(".scrollUp").removeClass("active"),lastScrollTop=o});
function update(){var i=$(window);i.width();if(stickySidebar.length>0){var t=$(".headWrap").outerHeight(!0),e=$(window).scrollTop()+t;e>sidebarTop?(stickySidebar.css("top",e-sidebarTop+32),stickyStop=$("main").offset().top+$("main").outerHeight(),stickyHeight=stickyStop-e,stickySidebar.height(stickyHeight)):(stickySidebar.css("top","0"),sidebarTop=stickySidebar.offset().top)}}var stickySidebar=$(".aside-nav");if(stickySidebar.length>0)var stickyHeight=stickySidebar.outerHeight(),sidebarTop=stickySidebar.offset().top;$(window).scroll(update),$(window).load(update),$(window).resize(function(){stickySidebar.css("top","0"),sidebarTop=stickySidebar.offset().top});
...
$('footer').append('<div class=".aside-nav" />');
$('.aside-nav').hide();

$(' <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/lightgallery/1.2.21/css/lightgallery.min.css"> ').appendTo("head");

$(window).load(function() {
    var toFancy = $('a[class*="ightbox"]');
    toFancy.each( function() {
        var Class = $(this).attr('class');
        var theClass = Class.substr(0, Class.length-8);
        $(this).removeClass().addClass(theClass+'Lg');
    });
   
    $('.owl-carousel a').each( function() {
        var imgSrc = $(this).find('.image').attr('data-src');
        $(this).attr({'data-sub-html':'.item-caption', 'data-exthumbimage':imgSrc});
    });
   
    $.when(
    $.getScript("https://cdnjs.cloudflare.com/ajax/libs/lightgallery/1.2.21/js/lightgallery-all.min.js"),
    $.Deferred(function(deferred) {
        $(deferred.resolve);
    })
).done(function() {
    $('.block-image').lightGallery({
        selector: 'a.Lg',
        thumbnail: false,
        download: false
    });
...
$("#text_BLOCK_U6N6SF90IY a").attr("href", "mailto:maconneriesminc@gmail.com");
